...
This page will guide you through the steps needed to prepare a computer for CORD development. Since CORD is built with
...
CORD development is easiest on Unix-based operating systems like macOS or Linux.
