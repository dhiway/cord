...
`Keypair` implements `subxt::tx::Signer<CordConfig>` and `Signer<PolkadotConfig>`, so you can pass it to any Subxt builder or SDK helper without manual conversions.
