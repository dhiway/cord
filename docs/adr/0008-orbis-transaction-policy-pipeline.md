...
`MetaAccountBoundPoliciesV6`, `VoterAuth`, Orbis Storage validation, and metadata validation. Thus a
...
The predecessor development iteration modelled Orbis Storage V6-to-V7 as a separate two-phase repair. A
...
the Orbis Storage V5-to-V7 composed migration. Orbis Storage declares storage V7 only at this boundary. Pallet indices remain unchanged. Manifest v4 records normalized checked artifacts and hashes; Orbis Storage V7 is present while provider V8 remains planned.
...
`PMIG-Orbis Storage-V6-to-V7` and `PMIG-Orbis Storage-V7-to-V8` identify predecessor-development evidence
