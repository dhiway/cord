...
pub use cord_braid_test_client::*;
pub use cord_braid_test_runtime as runtime;
pub use sc_consensus::LongestChain;
use std::sync::Arc;

pub use self::block_builder_ext::BlockBuilderExt;

use cord_braid_test_runtime::genesismap::GenesisStorageBuilder;
...
pub type Backend = cord_braid_test_client::Backend<cord_braid_test_runtime::Block>;

/// Test client executor.
pub type ExecutorDispatch =
	client::LocalCallExecutor<cord_braid_test_runtime::Block, Backend, WasmExecutor>;
...
pub type TestClientBuilder<E, B> = cord_braid_test_client::TestClientBuilder<
	cord_braid_test_runtime::Block,
	E,
	B,
	GenesisParameters,
>;
...
pub type Client<B> = client::Client<
	...
	cord_braid_test_runtime::Block,
	cord_braid_test_runtime::RuntimeApi,
>;
...
pub trait TestClientBuilderExt<B>: Sized {
	...
	fn build_with_longest_chain(
		self,
	) -> (Client<B>, sc_consensus::LongestChain<B, cord_braid_test_runtime::Block>);
