...
use cord_loom_node_cli::NODE_VERSION;
use std::process::Command;

const PREPARE_WORKER_EXE: &str = env!("CARGO_BIN_EXE_loom-prepare-worker");
const EXECUTE_WORKER_EXE: &str = env!("CARGO_BIN_EXE_loom-execute-worker");
