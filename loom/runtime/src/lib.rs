...
//! The CORD Loom runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
use cord_loom_runtime_constants::system_parachain::{coretime::TIMESLICE_PERIOD, BROKER_ID};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("dw-cord-loom"),
	authoring_version: 0,
...
parameter_types! {
	...
	pub BondingDuration: sp_staking::EraIndex = prod_or_fast!(
		28,
		28,
		"LOOM_BONDING_DURATION"
	);
	pub SlashDeferDuration: sp_staking::EraIndex = prod_or_fast!(
		27,
		27,
		"LOOM_SLASH_DEFER_DURATION"
	);
...
parameter_types! {
	...
	pub LeasePeriod: BlockNumber = prod_or_fast!(12 * WEEKS, 12 * WEEKS, "LOOM_LEASE_PERIOD");
	...
	pub LeaseOffset: BlockNumber = prod_or_fast!(64 * DAYS, 0, "LOOM_LEASE_OFFSET");
}
...
parameter_types! {
	...
	pub const MinContribution: Balance = 5 * UNITS;
...
parameter_types! {
	...
	pub const MigrationSignedDepositPerItem: Balance = MILLI;
	pub const MigrationSignedDepositBase: Balance = 20 * MILLI * 100;
...
construct_runtime! {
	pub enum Runtime
	{
		...
		Origins: pallet_custom_origins = 24,
		Whitelist: pallet_whitelist = 25,
...
mod benches {
	frame_benchmarking::define_benchmarks!(
		...
		[polkadot_runtime_parachains::assigner_on_demand, OnDemand]
...
sp_api::impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade(checks: frame_try_runtime::UpgradeCheckSelect) -> (Weight, Weight) {
			log::info!(target: LOG_TARGET, "try-runtime::on_runtime_upgrade loom.");
