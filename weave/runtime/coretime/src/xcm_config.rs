...
parameter_types! {
	pub const UntRelayLocation: Location = Location::parent();
...
impl xcm_executor::Config for XcmConfig {
	...
	type IsTeleporter = ConcreteAssetFromSystem<UntRelayLocation>;
	type UniversalLocation = UniversalLocation;
	type Barrier = Barrier;
	type Weigher = WeightInfoBounds<
		crate::weights::xcm::CoretimeLoomXcmWeight<RuntimeCall>,
		RuntimeCall,
		MaxInstructions,
	>;
