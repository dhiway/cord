...
impl<T: frame_system::Config> pallet_utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(27_448_783, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 2_578
			.saturating_add(Weight::from_parts(3_529_611, 0).saturating_mul(c.into()))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_parts(8_528_681, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 659
			.saturating_add(Weight::from_parts(3_765_727, 0).saturating_mul(c.into()))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_parts(8_892_822, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 599
			.saturating_add(Weight::from_parts(3_520_364, 0).saturating_mul(c.into()))
	}
