...
pub use pallet_election_provider_multi_phase::{
	Call as EPMCall, GeometricDepositBase, SolutionAccuracyOf,
};
...
use sp_runtime::{
	...
	traits::{
		self, AccountIdConversion, BlakeTwo256, Block as BlockT, ConvertInto, Keccak256, NumberFor,
...
parameter_types! {
	...
	pub const LPFee: Permill = Permill::from_perthousand(3);
