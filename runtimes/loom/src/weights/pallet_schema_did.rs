...
//! Autogenerated weights for `pallet_schema_did`
//!
...
/// Weight functions for `pallet_schema_did`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pallet_schema_did::WeightInfo for WeightInfo<T> {
	...
	/// Storage: `SchemaDid::Schemas` (r:1 w:1)
	/// Proof: `SchemaDid::Schemas` (`max_values`: None, `max_size`: Some(15542), added: 18017, mode: `MaxEncodedLen`)
