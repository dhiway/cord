...
impl<T: frame_system::Config> pallet_network_score::WeightInfo for WeightInfo<T> {
	...
	fn register_rating(_l: u32, ) -> Weight {
		...
		//  Measured:  `801`
		//  Estimated: `4144`
		// Minimum execution time: 47_280_000 picoseconds.
		Weight::from_parts(52_722_541, 0)
	...
	fn revoke_rating(_l: u32, ) -> Weight {
		...
		//  Measured:  `1328`
		//  Estimated: `7298`
		// Minimum execution time: 61_760_000 picoseconds.
		Weight::from_parts(70_136_662, 0)
	...
	fn revise_rating(_l: u32, ) -> Weight {
		...
		Weight::from_parts(70_947_669, 0)
			.saturating_add(Weight::from_parts(0, 7298))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(6))
	}
