...
use cord_braid_runtime_constants::currency::*;
...
pub fn compact_code_unwrap() -> &'static [u8] {
	cord_braid_runtime::WASM_BINARY.expect(
...
pub const SPEC_VERSION: u32 = cord_braid_runtime::VERSION.spec_version;

pub const TRANSACTION_VERSION: u32 = cord_braid_runtime::VERSION.transaction_version;
