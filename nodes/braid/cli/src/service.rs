...
use crate::cli::Cli;
use codec::Encode;
pub use cord_braid_runtime::RuntimeApi;
...
pub fn create_extrinsic(
	...
	function: impl Into<cord_braid_runtime::RuntimeCall>,
	nonce: Option<u32>,
) -> cord_braid_runtime::UncheckedExtrinsic {
...
exists; qed",
	...
	let period = cord_runtime_common::BlockHashCount::get()
		...
		.unwrap_or(2) as u64;
	let _tip = 0;
	let extra: cord_braid_runtime::SignedExtra = (
		pallet_network_membership::CheckNetworkMembership::<cord_braid_runtime::Runtime>::new(),
		frame_system::CheckNonZeroSender::<cord_braid_runtime::Runtime>::new(),
		frame_system::CheckSpecVersion::<cord_braid_runtime::Runtime>::new(),
		frame_system::CheckTxVersion::<cord_braid_runtime::Runtime>::new(),
		frame_system::CheckGenesis::<cord_braid_runtime::Runtime>::new(),
		frame_system::CheckMortality::<cord_braid_runtime::Runtime>::from(generic::Era::mortal(
			period,
			best_block.saturated_into(),
		)),
		frame_system::CheckNonce::<cord_braid_runtime::Runtime>::from(nonce),
		frame_system::CheckWeight::<cord_braid_runtime::Runtime>::new(),
	);

	let raw_payload = cord_braid_runtime::SignedPayload::from_raw(
		function.clone(),
		extra.clone(),
		(
			(),
			(),
			cord_braid_runtime::VERSION.spec_version,
			cord_braid_runtime::VERSION.transaction_version,
			genesis_hash,
			best_hash,
			(),
			(),
	...
	cord_braid_runtime::UncheckedExtrinsic::new_signed(
		function,
		sp_runtime::AccountId32::from(sender.public()).into(),
		cord_braid_runtime::Signature::Sr25519(signature),
		extra,
	)
}
