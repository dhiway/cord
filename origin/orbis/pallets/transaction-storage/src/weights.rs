...
//! Autogenerated weights for `pallet_orbis_transaction_storage`.
//!
//! Numbers below were copied from the upstream transaction-storage runtime weight file
//! (`upstream transaction-storage runtime/src/weights/pallet_orbis_transaction_storage.rs`,
//! frame-omni-bencher, 2026-05-22). The `RocksDbWeight` impl substitutes
...
/// Weight functions needed for pallet_orbis_transaction_storage.
...
/// Weights for pallet_orbis_transaction_storage using the Substrate node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn on_initialize_with_expiry(n: u32) -> Weight {
		...
		Weight::from_parts(7_640_000, 0)
			...
			// benchmark fixture contains only ordinary Orbis Storage entries.
