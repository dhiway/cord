...
The Orbis compatibility fork preserves upstream calls 0–13, modifies call 12 to use atomic
two-phase Bulletin reservations, adds calls 15 and 17, and intentionally leaves call indices 14
