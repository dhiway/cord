...
//! Bounded identity information used by the native Orbis People pallet.
//!
//! This is the first-network authoritative format, not a predecessor compatibility layout.
