...
//! Autogenerated weights for `pallet_orbis_hop_promotion`
//!
...
// pallet
// --extrinsic=*
// --runtime=<upstream-transaction-storage-runtime.wasm>
// --pallet=pallet_orbis_hop_promotion
// --header=the upstream benchmark header
// --output=./upstream transaction-storage runtime/src/weights
...
/// Weight functions for `pallet_orbis_hop_promotion`.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> pallet_orbis_hop_promotion::WeightInfo for WeightInfo<T> {
	...
	fn authorize_promote(d: u32, ) -> Weight {
		...
		Weight::from_parts(57_710_000, 0)
			...
			// Standard Error: 6
			.saturating_add(Weight::from_parts(1_390, 0).saturating_mul(d.into()))
