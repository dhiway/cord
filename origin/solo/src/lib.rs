...
use frame_support::{
	...
	parameter_types,
	traits::{
		fungible::HoldConsideration, ConstU32, Contains, InstanceFilter, KeyOwnerProofSystem,
		LinearStoragePrice, PrivilegeCmp, VariantCountOf,
	},
...
pub use origin_primitives::{AccountId, AccountPublic, Signature};
...
use sp_runtime::{
	...
	traits::{BlakeTwo256, Block as BlockT, NumberFor, OpaqueKeys, SaturatedConversion, Verify},
...
use origin_dev_runtime_constants::{currency::*, fee::WeightToFee, time::*};
...
parameter_types! {
	pub const TransactionByteFee: Balance = origin_dev_runtime_constants::fee::TRANSACTION_BYTE_FEE;
...
mod runtime {
	...
	pub type AuthorityManager = pallet_authorities::Pallet<Runtime>;
