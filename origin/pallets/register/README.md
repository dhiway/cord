# Origin register pallet

`pallet-origin-register` is the single CORD-owned register implementation shared by the Foundation
and Commons runtimes. There is no Orbis fork, compatibility facade, or duplicate state machine.
