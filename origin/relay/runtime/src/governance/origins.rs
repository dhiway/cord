...
pub mod pallet_custom_origins {
	...
	pub enum Origin {
		...
		StakingAdmin,
		/// Origin for spending up to $10,000,000 ORU from the treasury as well as generally
		/// administering it.
		Treasurer,
		...
		MediumSpender,
		/// Origin able to spend up to $1,000,000 ORU from the treasury at once.
		BigSpender,
