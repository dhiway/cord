...
impl<T: frame_system::Config> runtime_parachains::inclusion::WeightInfo for WeightInfo<T> {
	...
	fn enact_candidate(u: u32, h: u32, c: u32, ) -> Weight {
		...
		//  Measured:  `1501 + c * (15992 ±0) + h * (92 ±0) + u * (65723 ±0)`
		//  Estimated: `69051 + c * (17748 ±673) + h * (15057 ±681) + u * (41474 ±681)`
		// Minimum execution time: 580_654_000 picoseconds.
		Weight::from_parts(137_359_927, 0)
			.saturating_add(Weight::from_parts(0, 69051))
			// Standard Error: 442_109
			.saturating_add(Weight::from_parts(207_097_928, 0).saturating_mul(u.into()))
			// Standard Error: 442_109
			.saturating_add(Weight::from_parts(241_657_424, 0).saturating_mul(h.into()))
			// Standard Error: 732_628
			.saturating_add(Weight::from_parts(39_210_942, 0).saturating_mul(c.into()))
