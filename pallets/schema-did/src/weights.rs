...
/// Weight functions needed for `pallet_schema_did`.
pub trait WeightInfo {
	fn create(l: u32, ) -> Weight;
}

/// Weights for `pallet_schema_did` using the CORD node and recommended hardware.
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create(l: u32, ) -> Weight {
		...
		Weight::from_parts(37_960_558, 19007)
			// Standard Error: 10
			.saturating_add(Weight::from_parts(3_232, 0).saturating_mul(l.into()))
