...
// pub fn generate_rating_id<T: Config>(digest: &RatingEntryHashOf<T>) ->
// RatingIdOf { 	Ss58Identifier::to_scoring_id(&(digest).encode()[..]).unwrap()
// }

// pub fn generate_registry_id<T: Config>(digest: &RegistryHashOf<T>) ->
// RegistryIdOf { 	Ss58Identifier::to_registry_id(&(digest).encode()[..]).
// unwrap() }
...
// 	let t_id: TransactionIdentifierOf<Test> =
...
// 	let registry: InputRegistryOf<Test> =
// BoundedVec::try_from(raw_registry).unwrap(); 	let id_digest = <Test as
// frame_system::Config>::Hashing::hash( 		&[&registry.encode()[..],
// &creator.encode()[..]].concat()[..], 	);
...
// 		<Test as
// frame_system::Config>::Hashing::hash(&[&journal_entry.encode()[..]].
// concat()[..]);
...
// 		&[&registry_id.encode()[..], &delegate.encode()[..],
// &author.encode()[..]].concat()[..], 	);
