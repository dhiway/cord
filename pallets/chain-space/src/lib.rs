...
pub type SpaceCreatorOf<T> = AccountIdOf<T>;
/// Space Identifier
...
// TODO:
// Revist all extrinsics for the requirement of ensure_root by comparing with the
// pallet chain space did. Ex. reset transaction count currently requires
// Chain Space Origin i.e More Than Half Council.
