...
frame_support::construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		Treasury: network_treasury::{Pallet, Call, Storage, Config, Event<T>},
	}
);
...
pub fn new_test_ext() -> sp_io::TestExternalities {
	...
	pallet_balances::GenesisConfig::<Test> {
		// Total issuance will be 200 with network_treasury account initialized at ED.
...
// In case network_treasury account is not existing then it works fine.
...
fn inexistent_account_works() {
	...
	pallet_balances::GenesisConfig::<Test> { balances: vec![(0, 100), (1, 99), (2, 1)] }
		.assimilate_storage(&mut t)
		.unwrap();
	// Treasury genesis config is not build thus network_treasury account does not exist
...
fn genesis_funding_works() {
	...
	pallet_balances::GenesisConfig::<Test> {
		// Total issuance will be 200 with network_treasury account initialized with 100.
