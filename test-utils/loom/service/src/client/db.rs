...
type TestBackend = sc_client_api::in_mem::Backend<cord_loom_test_runtime::Block>;

#[test]
fn test_leaves_with_complex_block_tree() {
	let backend = Arc::new(TestBackend::new());

	cord_loom_test_runtime_client::trait_tests::test_leaves_for_backend(backend);
}
...
fn test_blockchain_query_by_number_gets_canonical() {
	...
	cord_loom_test_runtime_client::trait_tests::test_blockchain_query_by_number_gets_canonical(
		backend,
	);
}
