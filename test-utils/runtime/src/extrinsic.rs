...
use crate::{
	cord_test_pallet::pallet::Call as PalletCall, AccountId, Balance, BalancesCall, CheckCordCall,
	Extrinsic, Nonce, Pair, RuntimeCall, SignedPayload, TransferData,
};
use codec::Encode;
...
/// Transfer used in test cord pallet. Extrinsic is created and signed using this data.
#[derive(Clone)]
pub struct Transfer {
