...
// --extrinsic=create,update,revoke,remove
// --execution=wasm
// --wasm-execution=compiled
// --heap-pages=4096
// --header=./HEADER-GPL3
// --output=./runtime/src/weights/pallet_unique.rs
...
/// Weight functions for `pallet_unique`.
...
impl<T: frame_system::Config> pallet_unique::WeightInfo for WeightInfo<T> {
	...
	fn create(l: u32, ) -> Weight {
		...
		Weight::from_parts(15_317_960, 0)
			.saturating_add(Weight::from_parts(0, 15406533))
			// Standard Error: 12
			.saturating_add(Weight::from_parts(5_922, 0).saturating_mul(l.into()))
	...
	fn revoke(l: u32, ) -> Weight {
		...
		Weight::from_parts(16_552_629, 0)
			.saturating_add(Weight::from_parts(0, 15406533))
			// Standard Error: 17
			.saturating_add(Weight::from_parts(10_830, 0).saturating_mul(l.into()))
	...
	fn update(l: u32, ) -> Weight {
		...
		//  Estimated: `15406533`
		// Minimum execution time: 14_000_000 picoseconds.
		Weight::from_parts(14_835_807, 0)
			.saturating_add(Weight::from_parts(0, 15406533))
			// Standard Error: 12
			.saturating_add(Weight::from_parts(3_495, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: Unique UniqueIdentifiers (r:1 w:1)
	...
	fn remove(l: u32, ) -> Weight {
		...
		Weight::from_parts(13_360_318, 0)
			.saturating_add(Weight::from_parts(0, 15406533))
			// Standard Error: 10
			.saturating_add(Weight::from_parts(838, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
}