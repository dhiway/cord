...
impl<T: frame_system::Config> pallet_did_name::WeightInfo for WeightInfo<T> {
	...
	fn register(_n: u32, ) -> Weight {
		...
		Weight::from_parts(15_782_004, 0)
	...
	fn ban(n: u32, ) -> Weight {
		...
		Weight::from_parts(17_518_719, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 741
			.saturating_add(Weight::from_parts(27_043, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn unban(n: u32, ) -> Weight {
		...
		Weight::from_parts(11_111_815, 0)
			.saturating_add(Weight::from_parts(0, 3547))
			// Standard Error: 716
			.saturating_add(Weight::from_parts(23_365, 0).saturating_mul(n.into()))
