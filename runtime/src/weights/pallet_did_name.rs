...
impl<T: frame_system::Config> pallet_did_name::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, ) -> Weight {
		...
		Weight::from_parts(14_744_482, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 667
			.saturating_add(Weight::from_parts(4_909, 0).saturating_mul(n.into()))
	...
	fn ban(n: u32, ) -> Weight {
		...
		Weight::from_parts(16_758_675, 0)
			.saturating_add(Weight::from_parts(0, 3583))
			// Standard Error: 782
			.saturating_add(Weight::from_parts(34_140, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn unban(n: u32, ) -> Weight {
		...
		Weight::from_parts(10_622_424, 0)
			.saturating_add(Weight::from_parts(0, 3547))
			// Standard Error: 538
			.saturating_add(Weight::from_parts(20_917, 0).saturating_mul(n.into()))
