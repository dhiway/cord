...
impl<T: frame_system::Config> pallet_network_score::WeightInfo for WeightInfo<T> {
	...
	fn register_rating(_l: u32, ) -> Weight {
		...
		//  Measured:  `801`
		//  Estimated: `4144`
		// Minimum execution time: 51_190_000 picoseconds.
		Weight::from_parts(54_976_970, 0)
	...
	fn revoke_rating(l: u32, ) -> Weight {
		...
		Weight::from_parts(68_222_992, 0)
			.saturating_add(Weight::from_parts(0, 7298))
			// Standard Error: 60
			.saturating_add(Weight::from_parts(315, 0).saturating_mul(l.into()))
	...
	fn revise_rating(_l: u32, ) -> Weight {
		...
		Weight::from_parts(74_036_188, 0)
			.saturating_add(Weight::from_parts(0, 7298))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(6))
	}
