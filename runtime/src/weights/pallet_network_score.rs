...
impl<T: frame_system::Config> pallet_network_score::WeightInfo for WeightInfo<T> {
	...
	fn register_rating(l: u32, ) -> Weight {
		...
		//  Measured:  `743`
		//  Estimated: `4145`
		// Minimum execution time: 78_199_000 picoseconds.
		Weight::from_parts(80_215_337, 0)
	...
	fn revoke_rating(l: u32, ) -> Weight {
		...
		//  Measured:  `1271`
		//  Estimated: `7300`
		// Minimum execution time: 100_653_000 picoseconds.
		Weight::from_parts(103_561_594, 0)
	...
	fn revise_rating(l: u32, ) -> Weight {
		...
		//  Measured:  `1370`
		//  Estimated: `7300`
		// Minimum execution time: 103_075_000 picoseconds.
		Weight::from_parts(105_350_391, 0)
			.saturating_add(Weight::from_parts(0, 7300))
			// Standard Error: 15
			.saturating_add(Weight::from_parts(69, 0).saturating_mul(l.into()))
			.saturating_add(T::DbWeight::get().reads(9))
			.saturating_add(T::DbWeight::get().writes(6))
	}
}
