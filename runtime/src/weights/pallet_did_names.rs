...
impl<T: frame_system::Config> pallet_did_names::WeightInfo for WeightInfo<T> {
	...
	fn register(n: u32, ) -> Weight {
		...
		Weight::from_parts(20_869_716, 0)
			.saturating_add(Weight::from_parts(0, 10709))
			// Standard Error: 713
			.saturating_add(Weight::from_parts(6_493, 0).saturating_mul(n.into()))
	...
	fn ban(n: u32, ) -> Weight {
		...
		Weight::from_parts(20_746_509, 0)
			.saturating_add(Weight::from_parts(0, 7130))
			// Standard Error: 801
			.saturating_add(Weight::from_parts(31_853, 0).saturating_mul(n.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn unban(n: u32, ) -> Weight {
		...
		Weight::from_parts(14_977_242, 0)
			.saturating_add(Weight::from_parts(0, 3547))
			// Standard Error: 538
			.saturating_add(Weight::from_parts(25_385, 0).saturating_mul(n.into()))
