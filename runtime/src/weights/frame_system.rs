...
=======
		impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
				...
				// Standard Error: 6_000
				.saturating_add((1_699_000 as Weight).saturating_mul(i as Weight))
				.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(i as
				Weight)))
				}
				fn kill_storage(i: u32, ) -> Weight {
				(25_743_000 as Weight)
				...
				// Standard Error: 54_000
				.saturating_add((1_749_000 as Weight).saturating_mul(p as Weight))
				.saturating_add(T::DbWeight::get().writes((1 as Weight).saturating_mul(p as
				Weight)))
				}
				}
				...
				// Standard Error: 6_000
				.saturating_add((1_699_000 as Weight).saturating_mul(i as Weight))
				.saturating_add(RocksDbWeight::get().writes((1 as Weight).saturating_mul(i as
				Weight)))
				}
				fn kill_storage(i: u32, ) -> Weight {
				(25_743_000 as Weight)
				...
				// Standard Error: 54_000
				.saturating_add((1_749_000 as Weight).saturating_mul(p as Weight))
				.saturating_add(RocksDbWeight::get().writes((1 as Weight).saturating_mul(p as
				Weight)))
				}
				}
>>>>>>> origin/develop
