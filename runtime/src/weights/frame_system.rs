...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		Weight::from_parts(994_771, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 0
			.saturating_add(Weight::from_parts(519, 0).saturating_mul(b.into()))
	}
	/// The range of component `b` is `[0, 3932160]`.
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(2_410_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 946
			.saturating_add(Weight::from_parts(838_032, 0).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_parts(2_330_000, 0)
			.saturating_add(Weight::from_parts(0, 0))
			// Standard Error: 999
			.saturating_add(Weight::from_parts(642_024, 0).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_parts(4_354_000, 0)
			...
			.saturating_add(Weight::from_parts(1_353_109, 0).saturating_mul(p.into()))
