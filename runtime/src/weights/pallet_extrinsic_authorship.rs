...
impl<T: frame_system::Config> pallet_extrinsic_authorship::WeightInfo for WeightInfo<T> {
	...
	fn add(a: u32, ) -> Weight {
		...
		Weight::from_parts(12_303_598, 0)
			.saturating_add(Weight::from_parts(0, 990))
			// Standard Error: 9_901
			.saturating_add(Weight::from_parts(2_998_420, 0).saturating_mul(a.into()))
	...
	fn remove(a: u32, ) -> Weight {
		...
		Weight::from_parts(11_840_481, 0)
			.saturating_add(Weight::from_parts(0, 990))
			// Standard Error: 9_398
			.saturating_add(Weight::from_parts(4_211_306, 0).saturating_mul(a.into()))
			.saturating_add(T::DbWeight::get().reads((1_u64).saturating_mul(a.into())))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(a.into())))
			.saturating_add(Weight::from_parts(0, 2523).saturating_mul(a.into()))
	}
