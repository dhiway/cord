...
const descriptor=load("product-sdk/packages/descriptors/generated/orbis-descriptor.json"), vectors=load("origin/orbis/runtime/vectors/transaction-policy-v8/manifest.json");
