...
export const CLOUD_STORAGE_NATIVE_BINDINGS={metadataHash:COMMONS_NETWORK_BINDING.metadata_hash,runtimeApis:["StorageProviderApi.v10","DriveApi.v2","S3Api.v3"],routeCount:66,appRouteCount:61,services:["TransactionStorage","StorageProvider","Drive","S3"]} as const;
