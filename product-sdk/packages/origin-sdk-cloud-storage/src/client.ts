...
export const CLOUD_STORAGE_NATIVE_BINDINGS={metadataHash:COMMONS_NETWORK_BINDING.metadata_hash,runtimeApis:["StorageProviderApi.v10","DriveRegistryApi.v2","S3RegistryApi.v3"],routeCount:48,appRouteCount:43,services:["StorageProvider","Drive","S3"]} as const;
