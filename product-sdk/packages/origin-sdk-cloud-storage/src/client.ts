...
export const CLOUD_STORAGE_NATIVE_BINDINGS={metadataHash:COMMONS_NETWORK_BINDING.metadata_hash,runtimeApis:["StorageProviderApi.v1","DriveApi.v1","S3Api.v1"],routeCount:71,appRouteCount:66,services:["TransactionStorage","StorageProvider","Drive","S3"]} as const;
