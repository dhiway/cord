...
export const NATIVE_HOST_METHODS = [
  ...
  read("storage", "provider_root", ["provider"]),
  ...
  write("storage", "acknowledge_deletion", ["agreement_id", "content_commitment", "tombstone_root", "root_sequence", "leaf_index", "leaf_count", "inclusion_proof"]),
  write("storage", "commit_provider_root", ["sequence", "appended_leaves"]),
