...
const STORAGE_REGISTRY_SHA256 = "42e4e9660d7e2c26f15565a2448f9d2b384cb5c73321422a3b9ae9107f364b57";
...
function exactIntent<Operation extends StorageOperationV2>(
  ...
  if (intent.protocol !== "cord.origin.host/2" || intent.major !== 2
    || intent.minor !== 1 || intent.registrySha256 !== STORAGE_REGISTRY_SHA256
