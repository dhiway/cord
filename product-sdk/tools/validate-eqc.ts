...
const mp=resolve(root,"docs/evidence/performance/service-slo-manifest.json"),slo=load("docs/evidence/performance/service-slo-manifest.json"),env=load("docs/evidence/verification/p0/ratification-envelope.json");
...
process.stdout.write(`PASS E/Q/C strict schema/client harness; ratified=${status.ratified}; performance_claim=false\n`);
